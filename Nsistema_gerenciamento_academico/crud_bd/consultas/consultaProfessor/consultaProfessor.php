...
<body class="servicos_forms">
    ...
    <script>
        function atualizarProfessor(id_professor) {
            window.location.href = "../../cadastros/cadastroProfessor/formProfessor.php?id_professor=" + encodeURIComponent(id_professor);
        }
        ...
        function excluirProfessor(id_professor) {
            ...
            if (confirmar) {
                window.location.href = "excluirProfessor.php?id_professor=" + encodeURIComponent(id_professor);
            }
        }
    </script>
</body>
